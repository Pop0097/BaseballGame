		...
		do {
			...
			while (bats <= 2) { //This is where the user will determine the results for each team
				...
				do {
					...
					do { //this statement verifies that the user's input is correct. It takes the input as a string and then changes it to an integer to ensure that the code still runs, even if the user inputs a string
